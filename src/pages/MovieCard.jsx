...
const MovieCard = ({ movie, trailerUrl, onPlay }) => {
  return (
    <div className="relative rounded-xl shadow-lg cursor-pointer hover:scale-105 transition-transform duration-300">
      {/* Poster */}
      <img
        src={`${IMAGE_BASE_URL}${movie.poster_path}`}
        alt={movie.title}
        className="w-full h-full object-cover rounded-xl"
        onClick={() => trailerUrl && onPlay?.(trailerUrl)} // safe call
      />
